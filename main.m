...
% Last Modified by GUIDE v2.5 17-Nov-2018 21:30:53
...
img = imread('./img/b1.png');
set(handles.button1,'CData',img);

img = imread('./img/b2.png');
set(handles.button2,'CData',img);

img = imread('./img/b3.png');
set(handles.button3,'CData',img);

img = imread('./img/b4.png');
set(handles.button4,'CData',img);

img = imread('./img/b5.png');
set(handles.button5,'CData',img);

img = imread('./img/b6.png');
set(handles.button6,'CData',img);
...
% --- Executes during object creation, after setting all properties.
function button6_CreateFcn(hObject, eventdata, handles)
% hObject    handle to button6 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
